...
EXPECTED_ATTRIBUTE_LABELS: dict[str, str] = {
    ...
    "マギレコ": "魔法纪录",
    "まどドラ": "Magia Exedra",
    # Keys must match the values consumed by charaAt.js and the checkbox filter.
    # The visible labels may use expanded/canonical Chinese names.
    "神浜市立大附属": "神滨市立大学附属学校",
    "水名女学園": "水名女子学园",
    "参京院教育学園": "参京院教育学园",
    "栄総合学園": "荣综合学园",
...
def main() -> None:
    ...
    lines = [
        ...
        "- 显示名政策：`环彩羽`、`常盘七香`、`万年樱的传闻`、`早乙女和子`为唯一界面显示名；其他译名仅作为搜索兼容别名。",

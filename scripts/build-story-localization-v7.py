...
MANUAL_CHARACTER_ALIASES = {
    ...
    "小さなキュゥべえ": "小丘比", "キュゥべえ": "丘比", "ピンクのキュゥべえ": "粉色丘比",
    "ジュゥべえ": "朱比", "ウワサさん": "谣先生", "まばゆの母": "眩的母亲",
    "鹿目詢子": "鹿目询子", "早乙女先生": "早乙女和子", "上条恭介": "上条恭介",
    "灯花の父": "灯花的父亲", "里見太助": "里见太助", "夏希の兄": "夏希的哥哥",
    "まどか先輩・いろはちゃん": "小圆前辈·小彩羽", "まどか先輩＆いろはちゃん": "小圆前辈与小彩羽",
}
